...
correl <- read.csv("correlations.csv", stringsAsFactors = FALSE) ##Correlations of every plot in every lineup
full <- read.csv("full.csv", row.names=1, stringsAsFactors = FALSE) ##MTurk evaluations
prediction <- read.csv("sas/predfit.csv") ##fitted data from SAS
...
<<smoothing, dependson='setup', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
set.seed(123)
...
\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}
<<smoothing2, dependson='smoothing', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
...
\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}
<<smoothing3, dependson='smoothing', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
...
\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}
<<smoothing4, dependson='smoothing', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
...
\end{subfigure}
  \caption{The same AR(1) data both unsmoothed (\subref{smootha} and \subref{smoothb}) and smoothed (\subref{smoothc} and \subref{smoothd}) for both plot designs. t = 96, correlation = 0.86}
  \label{smoothing}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \begin{subfigure}[t]{0.24\textwidth}
<<designs, dependson='setup', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
set.seed(101)
a <- gen_true_data(24, 0.95)
...
\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}
<<designs2, dependson='designs', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
...
\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}
<<designs3, dependson='designs', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
...
\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}
<<designs4, dependson='designs', fig.width=4, fig.height=4, out.width='0.7\\textwidth', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
...
\end{subfigure}
\caption{The same two data sets in both plot designs. t=24, correlation (\subref{designa} and \subref{designc}) = 0.946, correlation (\subref{designb} and \subref{designd})  = -0.943}
\label{designs}
\end{figure}
...
ggplot(data=prop) + geom_errorbar(aes(x=r, ymax=upper, ymin=lower)) + geom_point(aes(x=r, y=difference)) +
        geom_hline(aes(yintercept=0, colour="red")) + labs(x="Correlation", y="Difference between plot designs") + facet_grid(n~smoothed)
@
...
ggplot(data=subset(bylineup, smoothed==0), aes(x=r, y=percent, colour=factor(n))) + geom_smooth(se=F) + geom_point() + facet_grid(design~.) + scale_colour_discrete(name = "Sample size") +  labs(y="True plot detected rate", x="Correlation") + theme(legend.position="bottom")
@
...
<<pins, dependson='setup', out.width='1\\linewidth',  out.height='0.2\\textheight', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
...
ggplot(data=filter(pin, smoothed==0 & design == "Scatterplot")) + 
         ...
         geom_point(aes(x=correlation, y=percent, colour=true)) + coord_fixed() + facet_grid(n~r) + 
         labs(y="Percent Chosen") + theme(legend.position="none")
@
\subcaption{}\label{pin1}
\end{subfigure}
\begin{subfigure}[htbp]{1\textwidth}
<<pin2, dependson='pins', out.width='1\\linewidth', out.height='0.2\\textheight', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
ggplot(data=subset(pin, smoothed==1 & design == "Scatterplot")) + 
         geom_errorbar(aes(x=correlation, ymin=base, ymax=percent, colour=true)) +
         geom_point(aes(x=correlation, y=percent, colour=true)) + coord_fixed()  + facet_grid(n~r) + 
         labs(y="Percent Chosen") + theme(legend.position="none")
@
\subcaption{}\label{pin2}
\end{subfigure}
\begin{subfigure}[htbp]{1\textwidth}
<<pin3, dependson='pin', out.width='1\\linewidth', out.height='0.2\\textheight', echo=FALSE, warning=FALSE, message=FALSE, error=FALSE>>=
