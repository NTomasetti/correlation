...
rownames(scatter.fit) <- c("Intercept", "abs(r)", "sign(r)", "smooth", "sample size", "Interaction(r+, r-)")
...
kable(time.fit[1:7,], format="latex", caption="Main Effects")
kable(time.fit[8:14,], format="latex", caption="Interaction Effects")
@
\end{table}
