...
Further analysis was carried out using \citet{R} version 3.1.2 and \citet{RStudio} version 0.99.484 using the packages: \citet{dplyr}, \citet{ggplot2}, \citet{grid}, \citet{gridExtra}, \citet{gridSVG}, \citet{knitr}, \citet{maps}, \citet{mFilter}, \citet{mnormt}, \citet{nullabor}, \citet{stringr} and \citet{tidyr}.
