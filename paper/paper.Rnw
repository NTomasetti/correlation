...
\begin{figure}[htbp]
  \centering
    \centerline{\begin{subfigure}[width=0.45\textwidth]
    <<nzd, error=FALSE, message=FALSE, warning=FALSE, echo=FALSE>>=
    rates <- select(read.csv("rates.csv"), date, AUD, CNY, NZD)[36:69,]
...
\begin{figure}[width=0.5\textwidth][htbp]
  \centering
  <<cny, dependson='nzd2', error=FALSE, message=FALSE, warning=FALSE, echo=FALSE>>=
