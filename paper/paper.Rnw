...
#pander(summary(m8s)$coefficients, justify=c('left', 'right', 'right', 'right', 'right'), caption="Model fit for scatter plots")
#library(xtable)
kable(summary(m8s)$coefficients, format="latex")
@
\end{table}
