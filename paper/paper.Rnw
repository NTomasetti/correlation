...
\begin{figure}[htbp]
  \centering
  \begin{subfigure}
    \includegraphics{nzd scatter}
  \end{subfigure}
  \begin{subfigure}
    \includegraphics{nzd line}
  \end{subfigure}
